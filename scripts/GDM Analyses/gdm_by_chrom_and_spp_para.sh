...
#sp_array=("NITENS" "SINUATUS")
#ch_array=("1A" "1B" "4A" "LG2" "LG5" "LGE22" "mtDNA" "Z")

## all species independently
for spp in ${sp_array[@]}; do
nohup Rscript "/Users/kprovost/Documents/Github/GDM_pipeline/scripts/GDM Analyses/run_GDMS.R" $spp >> gdm_results_jan2020_full_${spp}_morphpcs.txt 2>&1 &
done
