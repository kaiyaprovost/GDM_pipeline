...
# then load the shapefile back into R. Adjust the file path for your machine, and make sure the working directory is set to one level up from the folder that contains the countries file.
