...
new_ttests = permuteDeserts(SPECIES="MELANURA",N=100,data=males,colNumber=35)

## not working anymore after change permuteDeserts
for (colNumber in 24:length(names(males))) {
...
for (colNumber in 24:length(names(males))) {
  for (SPECIES in unique(males$SPP)) {
    print(c(names(males)[colNumber],SPECIES))
    par(ask=F)
    s = sum(males$SPP[males$WHICH.SIDE.OF.CFB=="SONORAN"] == SPECIES,na.rm=T)
    c = sum(males$SPP[males$WHICH.SIDE.OF.CFB=="CHIHUAHUAN"] == SPECIES,na.rm=T)
    if (c != 0 && s != 0) {
      permuteDeserts(SPECIES=SPECIES,N=100,data=males,colNumber=colNumber)
    }
  }
...
png("Images/aggregated_beakAreaVolume_LOG_RESIDUALS.png")
...
png("Images/aggregated_beakLateralSurfArea_LOG_RESIDUALS.png")
...
png("Images/aggregated_beakVolume_LOG_RESIDUALS.png")
...
png("Images/aggregated_beakLateralSurfArea_overlap_byDesert_LOG_RESIDUALS.png")
boxplot(son$RES_LOG_BEAKLATERALSURFACE_CALC
        ~son$SPP,border=rgb(0,0.5,0,1),ylim=c(-1,1.25),add=F,col=rgb(0,1,0,1),
        las=2,boxwex=0.33,names=rep("",11),at=(seq(1,11)-2/3))
boxplot(chi$RES_LOG_BEAKLATERALSURFACE_CALC
        ~chi$SPP,border=rgb(0,0.5,1,1),ylim=c(-1,1.25),add=T,col=rgb(0,1,1,1),
        las=2,boxwex=0.33,names=rep("",11),at=(seq(1,11)-1/3))
boxplot(chi$RES_LOG_BEAKLATERALSURFACE_CALC
        ~chi$SPP,border=rgb(0,0.5,1,0),ylim=c(-1,1.25),add=T,col=rgb(0,1,1,0),
        las=2,boxwex=0.33,at=seq(0.5,10.5))
dev.off()

png("Images/aggregated_beakVolume_overlap_byDesert_LOG_RESIDUALS.png")
boxplot(son$RES_LOG_BEAKVOL_CALC
        ~son$SPP,border=rgb(0,0.5,0,1),ylim=c(-2,2),add=F,col=rgb(0,1,0,1),
        las=2,boxwex=0.33,names=rep("",11),at=(seq(1,11)-2/3))
boxplot(chi$RES_LOG_BEAKVOL_CALC
        ~chi$SPP,border=rgb(0,0.5,1,1),ylim=c(-2,2),add=T,col=rgb(0,1,1,1),
        las=2,boxwex=0.33,names=rep("",11),at=(seq(1,11)-1/3))
boxplot(chi$RES_LOG_BEAKVOL_CALC
        ~chi$SPP,border=rgb(0,0.5,1,0),ylim=c(-2,2),add=T,col=rgb(0,1,1,0),
        las=2,boxwex=0.33,at=seq(0.5,10.5))
dev.off()

png("Images/aggregated_beakAreaVolume_overlap_byDesert_LOG_RESIDUALS.png")
boxplot(son$RES_LOG_BEAKAREAVOLUME_CALC
        ~son$SPP,border=rgb(0,0.5,0,1),ylim=c(-1,1),add=F,col=rgb(0,1,0,1),
        las=2,boxwex=0.33,names=rep("",11),at=(seq(1,11)-2/3))
boxplot(chi$RES_LOG_BEAKAREAVOLUME_CALC
        ~chi$SPP,border=rgb(0,0.5,1,1),ylim=c(-1,1),add=T,col=rgb(0,1,1,1),
        las=2,boxwex=0.33,names=rep("",11),at=(seq(1,11)-1/3))
boxplot(chi$RES_LOG_BEAKAREAVOLUME_CALC
        ~chi$SPP,border=rgb(0,0.5,1,0),ylim=c(-1,1),add=T,col=rgb(0,1,1,0),
        las=2,boxwex=0.33,at=seq(0.5,10.5))
dev.off()

png("Images/aggregated_kipps_overlap_byDesert_LOG_RESIDUALS.png")
boxplot(son$RES_LOG_KIPPSINDEX_CALC
        ~son$SPP,border=rgb(0,0.5,0,1),ylim=c(-1,1),add=F,col=rgb(0,1,0,1),
        las=2,boxwex=0.33,names=rep("",11),at=(seq(1,11)-2/3))
boxplot(chi$RES_LOG_KIPPSINDEX_CALC
        ~chi$SPP,border=rgb(0,0.5,1,1),ylim=c(-1,1),add=T,col=rgb(0,1,1,1),
        las=2,boxwex=0.33,names=rep("",11),at=(seq(1,11)-1/3))
boxplot(chi$RES_LOG_KIPPSINDEX_CALC
        ~chi$SPP,border=rgb(0,0.5,1,0),ylim=c(-1,1),add=T,col=rgb(0,1,1,0),
...
for (spp in unique(males$SPP)) {
  for (des in unique(males$WHICH.SIDE.OF.CFB)) {
    #print(paste(spp,des))
    tab = males[males$SPP==spp & males$WHICH.SIDE.OF.CFB==des,c(24:length(names(males)))]
    ...
    names(m) = sppdes
    tm = t(m)
    write(paste("SPP_DES",names(tab),collapse=",",sep=","),"KLP_Master_Spreadsheet_Morphology_AGGREGATED_LOG_RESIDUALS_MEAN.csv",
          append=T,sep=",")
    write.table(tm,"KLP_Master_Spreadsheet_Morphology_AGGREGATED_LOG_RESIDUALS_MEAN.csv",
                append=T,sep=",",col.names=F)
  }
}


spp_list=paste(unique(males$SPP),collapse="\t")
colnames_list = paste(colnames(tabS),collapse="\t")

write(paste("SPECIES\t",colnames_list,sep=""),"output_LOG_RES.txt",append=T,sep="\t")

for (spp in unique(males$SPP)) {
  print(spp)
  #write(spp,"output_LOG_RES.txt",append=T,sep="\t",ncolumns=3)
  tabS = males[males$SPP==spp & males$WHICH.SIDE.OF.CFB=="SONORAN",c(24:length(names(males)))]
  tabC = males[males$SPP==spp & males$WHICH.SIDE.OF.CFB=="CHIHUAHUAN",c(24:length(names(males)))]
  for (colnum in 1:length(colnames(tabS))) {
    #write(colnames(tabS)[colnum],"output_LOG_RES.txt",append=T,sep="\t",ncolumns=3)
    print(colnum)
    if ((nrow(tabC) != 0) && (nrow(tabS) != 0) && sum(!is.na(tabC[,colnum])) > 1 && sum(!is.na(tabS[,colnum])) > 1) {
      test = t.test(tabS[,colnum],tabC[,colnum])
      #write(test$p.value,"output_LOG_RES.txt",append=T,sep="\n",ncolumns=3)
      
      write(c(spp,colnames(tabS)[colnum],test$p.value),"output_LOG_RES.txt",append=T,sep="\t",ncolumns=3)
      
    } else {
      #write("#####","output_LOG_RES.txt",append=T,sep="\n",ncolumns=3)
      write(c(spp,colnames(tabS)[colnum],"#####"),"output_LOG_RES.txt",append=T,sep="\t",ncolumns=3)
      
    }
  }
}

## again need to fix this so that the data is legible 

#### CURRENTLY NOT WORKING
testtable = read.table("sonVsChit-test_LOG_RES.txt",header=T,
                       sep="\t")
...
for (colNumber in c(4:10,13,15:19,41:47)) {
  for (SPECIES in unique(males$SPP)) {
    print(c(names(males)[colNumber],SPECIES))
    par(ask=F)
    s = sum(males$SPP[males$WHICH.SIDE.OF.CFB=="SONORAN"] == SPECIES,na.rm=T)
...
png("Images/aggregated_beakAreaVolume.png")
...
png("Images/aggregated_beakLateralSurfArea.png")
boxplot(as.numeric(males$BEAKLATERALSURFACE_CALC)~males$SPP,horizontal=F,
        names=c("car","sin","fus","cur","cri","bil","bru","nit","fla","bel","mel"),
        col=c("cyan","white","cyan","cyan","white","white","red","white","red","cyan","grey"))
dev.off()

png("Images/aggregated_beakVolume.png")
...
png("Images/aggregated_kipps_overlap_byDesert.png")
boxplot(son$KIPPSINDEX_CALC
        ~son$SPP,border=rgb(0,0.5,0,1),ylim=c(0,25),add=F,col=rgb(0,1,0,1),
        las=2,boxwex=1,names=names)
boxplot(chi$KIPPSINDEX_CALC
        ~chi$SPP,border=rgb(0,0.5,1,1),ylim=c(0,25),add=T,col=rgb(0,1,1,1),
        las=2,boxwex=0.5,names=names)
dev.off()


## min not meaningful for factors 
for (i in c(4:10,13,15:19,41:47)) {
  n = names(son)[i]
  min = floor(min(son[,i],chi[,i],na.rm=T)*4)/4
  max = ceiling(max(son[,i],chi[,i],na.rm=T)*4)/4
  png(paste("Images/aggregated_",n,"_byDesert.png",sep=""),
      pointsize=18)
...
png("Images/aggregated_beakLateralSurfaceArea_byDesert.png")
...
png("Images/aggregated_beakAreaVolume_byDesert.png")
...
png("Images/aggregated_beakVolume_overlap_byDesert.png")
...
png("Images/aggregated_beakLateralSurfArea_overlap_byDesert.png")
boxplot(son$BEAKLATERALSURFACE_CALC
        ~son$SPP,border=rgb(0,0.5,0,1),ylim=c(0,450),add=F,col=rgb(0,1,0,1),
        las=2,boxwex=1)
boxplot(chi$BEAKLATERALSURFACE_CALC
        ~chi$SPP,border=rgb(0,0.5,1,1),ylim=c(0,450),add=T,col=rgb(0,1,1,1),
        las=2,boxwex=0.5)
dev.off()

png("Images/aggregated_beakVolume_overlap_byDesert.png")
boxplot(son$BEAKVOL_CALC
        ~son$SPP,border=rgb(0,0.5,0,1),ylim=c(0,3500),add=F,col=rgb(0,1,0,1),
        las=2,boxwex=1)
boxplot(chi$BEAKVOL_CALC
        ~chi$SPP,border=rgb(0,0.5,1,1),ylim=c(0,3500),add=T,col=rgb(0,1,1,1),
        las=2,boxwex=0.5)
dev.off()

png("Images/aggregated_beakAreaVolume_overlap_byDesert.png")
boxplot(son$BEAKAREAVOLUME_CALC
        ~son$SPP,border=rgb(0,0.5,0,1),ylim=c(0,0.7),add=F,col=rgb(0,1,0,1),
        las=2,boxwex=1)
boxplot(chi$BEAKAREAVOLUME_CALC
        ~chi$SPP,border=rgb(0,0.5,1,1),ylim=c(0,0.7),add=T,col=rgb(0,1,1,1),
        las=2,boxwex=0.5)
dev.off()
...
for (spp in unique(males$SPP)) {
  for (des in unique(males$WHICH.SIDE.OF.CFB)) {
    #print(paste(spp,des))
    tab = males[males$SPP==spp & males$WHICH.SIDE.OF.CFB==des,c(4:10,13,15:19,41:47)]
    m = as.data.frame(sapply(tab,mean))
    #s = sapply(tab,sd)
    #names(spp) = "SPP"
    #names(des) = "WHICH.SIDE.OF.CFB"
    ...
    names(m) = sppdes
    tm = t(m)
    write.table(tm,"KLP_Master_Spreadsheet_Morphology_AGGREGATED_means.csv",
                append=T,sep=",",col.names=F)
  }
}


means_values = read.table("KLP_Master_Spreadsheet_Morphology_AGGREGATED_means.csv",
                          sep=",",header=T)
names(means_values)[1] = "SPPDES"
#par(ask=T)

## Error in `[.data.frame`(means_values, i) : undefined columns selected
...
for (spp in unique(males$SPP)) {
  write(spp,"output.txt",append=T,sep="\t",ncolumns=3)
  tabS = males[males$SPP==spp & males$WHICH.SIDE.OF.CFB=="SONORAN",c(4:10,13,15:19,41:47)]
  tabC = males[males$SPP==spp & males$WHICH.SIDE.OF.CFB=="CHIHUAHUAN",c(4:10,13,15:19,41:47)]
  for (colnum in 1:length(colnames(tabS))) {
    write(colnames(tabS)[colnum],"output.txt",append=T,sep="\t",ncolumns=3)
    if ((nrow(tabC) != 0) && (nrow(tabS) != 0)) {
      test = t.test(tabS[,colnum],tabC[,colnum])
      write(test$p.value,"output.txt",append=T,sep="\n",ncolumns=3)
    } else {
      write("#####","output.txt",append=T,sep="\n",ncolumns=3)
    }
  }
}

testtable = read.table("sonVsChit-test.txt",header=T,
                       sep="\t")

png("Images/sonVsChit-test.png")
...
png("Images/sonVsChit-test_panel.png")
ramp = brewer.pal(12,"Paired")
ramp[11] = "grey"
rain = rainbow(14)
cols = c("black","black",ramp)
...
png("Images/sonVsChit-test_zoom.png")
ramp = brewer.pal(12,"Paired")
ramp[11] = "grey"
rain = rainbow(14)
cols = c("black","black",ramp)
...
png("Images/sonVsChit-test_zoom01.png")
ramp = brewer.pal(12,"Paired")
ramp[11] = "grey"
rain = rainbow(14)
cols = c("black","black",ramp)
...
png("Images/morph_pca_spp_enm_not_26feb2017.png",
...
png("Images/morph_pca_1vs2_spp_arrows_str_26feb2017.png",
    width=12,height=6,pointsize=1,units="cm",
    res=500)
#par(mfrow=c(1,1),mar=c(0,0,0,0))
print(g)
...
png("Images/morph_pca_1vs3_spp_arrows_str_26feb2017.png",
    width=12,height=6,pointsize=1,units="cm",
    res=500)
#par(mfrow=c(1,1),mar=c(0,0,0,0))
print(g)
...
png("Images/morph_pca_2vs3_spp_arrows_str_26feb2017.png",
    width=12,height=6,pointsize=1,units="cm",
    res=500)
#par(mfrow=c(1,1),mar=c(0,0,0,0))
print(g)
...
png("Images/fusca_pca_26feb2017.png",
...
png("Images/fusca_pca_nomiddle_26feb2017.png",
    width=12,height=8,pointsize=1,units="cm",
    res=500)
#par(mfrow=c(1,1),mar=c(0,0,0,0))
print(g)
...
png("Images/cardinalis_pca_26feb2017.png",
    width=12,height=8,pointsize=1,units="cm",
    res=500)
par(mfrow=c(1,1),mar=c(0,0,0,0))
print(g)
...
png("Images/sinuatus_pca_26feb2017.png",
    width=12,height=8,pointsize=1,units="cm",
    res=500)
par(mfrow=c(1,1),mar=c(0,0,0,0))
print(g)
...
png("Images/flaviceps_pca_26feb2017.png",
    width=12,height=8,pointsize=1,units="cm",
    res=500)
par(mfrow=c(1,1),mar=c(0,0,0,0))
print(g)
...
png("Images/brunneicapillus_pca_26feb2017.png",
    width=12,height=8,pointsize=1,units="cm",
    res=500)
par(mfrow=c(1,1),mar=c(0,0,0,0))
print(g)
...
png("Images/curvirostre_pca_26feb2017.png",
    width=12,height=8,pointsize=1,units="cm",
    res=500)
par(mfrow=c(1,1),mar=c(0,0,0,0))
print(g)
...
png("Images/melanura_pca_26feb2017.png",
    width=12,height=8,pointsize=1,units="cm",
    res=500)
par(mfrow=c(1,1),mar=c(0,0,0,0))
print(g)
...
png("Images/bellii_pca_26feb2017.png",
    width=12,height=8,pointsize=1,units="cm",
    res=500)
par(mfrow=c(1,1),mar=c(0,0,0,0))
print(g)
...
png("Images/nitens_pca_26feb2017.png",
    width=12,height=8,pointsize=1,units="cm",
    res=500)
par(mfrow=c(1,1),mar=c(0,0,0,0))
print(g)
...
png("Images/bilineata_pca_26feb2017.png",
    width=12,height=8,pointsize=1,units="cm",
    res=500)
par(mfrow=c(1,1),mar=c(0,0,0,0))
print(g)
...
png("Images/pc1_vs_pi_26feb2017.png",
...
png("Images/suitability20_vs_pi_26feb2017.png",
    width=12,height=8,pointsize=12,units="cm",
    res=500)
par(mfrow=c(1,1),bg="black",col.axis="white",col.lab="white",
    col.main="white",col.sub="white",
...
png("Images/suitThresh_vs_pi_26feb2017.png",
    width=12,height=8,pointsize=12,units="cm",
    res=500)
par(mfrow=c(1,1),bg="black",col.axis="white",col.lab="white",
    col.main="white",col.sub="white",
...
genmorph = morph[morph$STRUCTURE!=0.5,]
