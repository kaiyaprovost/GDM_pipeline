...
if (FIRSTSTEP <= 7) {
  ...
  Env = stack("/home/kprovost/nas1/ENMs/ENMS_multilayer_onlyworldclim.tif")
  LGM = stack("/home/kprovost/nas1/ENMs/ENMS_multilayer_LGM.tif")
  MID = stack("/home/kprovost/nas1/ENMs/ENMS_multilayer_MID.tif")
  ...
  outdirectory="/home/kprovost/nas1/ENMs/WORLDCLIM/"
  setwd(outdirectory)
  ...
  for (thinfile in thinned_csvs) {
    ...
    if(plotStuff == T) {
      ...
      ## LGM
      pred.LGM = predict(LGM, res@models[[best]])
      writeRaster(pred.LGM,filename=paste("AddedPredThin_BestModel_",sppname,"_addedLayers_LGM.asc",sep=""),
                  format="ascii",overwrite=T)
      png(paste("PredThin_BestModel_",sppname,"_addedLayers_LGM.png",sep=""))
      plot(pred.LGM, col=viridis::viridis(99),main=sppname)
      points(loc,pch=3,col=rgb(1,0,0,0.1))
      dev.off()
      png(paste("PredThin_avg.test.AUC_",sppname,"_addedLayers_LGM.png",sep=""))
      eval.plot(res@results, "avg.test.AUC")
      dev.off()
      ...
      LGM.spsen = pred.LGM>= th1$spec_sens ## equal sensitivity and specificity according to ROC curve
      writeRaster(LGM.nomit,filename=paste("Thresh_NoOmission_BestModel_",sppname,"_addedLayers_LGM.asc",sep=""),
                  format="ascii",overwrite=T)
      writeRaster(LGM.equal,filename=paste("Thresh_EqualSensSpec_BestModel_",sppname,"_addedLayers_LGM.asc",sep=""),
                  format="ascii",overwrite=T)
      writeRaster(LGM.spsen,filename=paste("Thresh_MaxSpecSens_BestModel_",sppname,"_addedLayers_LGM.asc",sep=""),
                  format="ascii",overwrite=T)
      png(paste("Thresh_NoOmission_BestModel_",sppname,"_addedLayers_LGM.png",sep=""))
      plot(LGM.nomit, col=viridis::viridis(99))
      points(loc,pch=3,col=rgb(1,0,0,0.1))
      dev.off()
      png(paste("Thresh_EqualSensSpec_BestModel_",sppname,"_addedLayers_LGM.png",sep=""))
      plot(LGM.equal, col=viridis::viridis(99))
      points(loc,pch=3,col=rgb(1,0,0,0.1))
      dev.off()
      png(paste("Thresh_MaxSpecSens_BestModel_",sppname,"_addedLayers_LGM.png",sep=""))
      plot(LGM.spsen, col=viridis::viridis(99))
      points(loc,pch=3,col=rgb(1,0,0,0.1))
      dev.off()
      ...
      pred.MID = predict(MID, res@models[[best]])
      writeRaster(pred.MID,filename=paste("AddedPredThin_BestModel_",sppname,"_addedLayers_MID.asc",sep=""),
                  format="ascii",overwrite=T)
      png(paste("PredThin_BestModel_",sppname,"_addedLayers_MID.png",sep=""))
      plot(pred.MID, col=viridis::viridis(99),main=sppname)
      points(loc,pch=3,col=rgb(1,0,0,0.1))
      dev.off()
      png(paste("PredThin_avg.test.AUC_",sppname,"_addedLayers_MID.png",sep=""))
      eval.plot(res@results, "avg.test.AUC")
      dev.off()
      
      MID.nomit = pred.MID>= th1$no_omission ## the highest thresh where no points are omittec
      MID.equal = pred.MID>= th1$equal_sens_spec ## equal sensitivity and specificity according to ROC curve
      MID.spsen = pred.MID>= th1$spec_sens ## equal sensitivity and specificity according to ROC curve
      writeRaster(MID.nomit,filename=paste("Thresh_NoOmission_BestModel_",sppname,"_addedLayers_MID.asc",sep=""),
                  format="ascii",overwrite=T)
      writeRaster(MID.equal,filename=paste("Thresh_EqualSensSpec_BestModel_",sppname,"_addedLayers_MID.asc",sep=""),
                  format="ascii",overwrite=T)
      writeRaster(MID.spsen,filename=paste("Thresh_MaxSpecSens_BestModel_",sppname,"_addedLayers_MID.asc",sep=""),
                  format="ascii",overwrite=T)
      png(paste("Thresh_NoOmission_BestModel_",sppname,"_addedLayers_MID.png",sep=""))
      plot(MID.nomit, col=viridis::viridis(99))
      points(loc,pch=3,col=rgb(1,0,0,0.1))
      dev.off()
      png(paste("Thresh_EqualSensSpec_BestModel_",sppname,"_addedLayers_MID.png",sep=""))
      plot(MID.equal, col=viridis::viridis(99))
      points(loc,pch=3,col=rgb(1,0,0,0.1))
      dev.off()
      png(paste("Thresh_MaxSpecSens_BestModel_",sppname,"_addedLayers_MID.png",sep=""))
      plot(MID.spsen, col=viridis::viridis(99))
      points(loc,pch=3,col=rgb(1,0,0,0.1))
      dev.off()
    }
