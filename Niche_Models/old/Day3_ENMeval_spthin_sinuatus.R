...
## THEN DID FIND AND REPLACE FOR PROSOPSIS GLANDULOSA
...
writeRaster(pred.raw,filename="PredRaw_BestModel_sinuatus.asc",
            format="ascii",overwrite=T)
png("PredRaw_BestModel_sinuatus.png")
...
png("ThinnedPlot_Mean.AUC_sinuatus.png")
...
writeRaster(pred.thin,filename="Thinned_PredRaw_BestModel_sinuatus.asc",
            format="ascii",overwrite=T)
png("Thinned_PredRaw_BestModel_sinuatus.png")
...
writeRaster(p1.nomit,filename="Thinned_Thresh_NoOmission_BestModel_sinuatus.asc",
            format="ascii",overwrite=T)
writeRaster(p1.equal,filename="Thinned_Thresh_EqualSensSpec_BestModel_sinuatus.asc",
            format="ascii",overwrite=T)
png("Thinned_Thresh_NoOmission_BestModel_sinuatus.png")
plot(p1.nomit, col=viridis::viridis(99))
dev.off()
png("Thinned_Thresh_EqualSensSpec_BestModel_sinuatus.png")
...
png("MinConvexPolygon_sinuatus.png")
...
png("MinConvexPolygon_points_sinuatus.png")
plot(Env[[1]], col=viridis::viridis(99))
...
png("BgPointsPlot_Mean.AUC_sinuatus.png")
...
writeRaster(pred.bg,filename="BgPointsPlot_PredRaw_BestModel_sinuatus.asc",
            format="ascii",overwrite=T)
png("BgPointsPlot_PredRaw_BestModel_sinuatus.png")
...
writeRaster(p2.nomit,filename="BgPoints_Thresh_NoOmission_BestModel_sinuatus.asc",
            format="ascii",overwrite=T)
writeRaster(p2.equal,filename="BgPoints_Thresh_EqualSensSpec_BestModel_sinuatus.asc",
            format="ascii",overwrite=T)
png("BgPoints_Thresh_NoOmission_BestModel_sinuatus.png")
plot(p2.nomit, col=viridis::viridis(99))
dev.off()
png("BgPoints_Thresh_EqualSensSpec_BestModel_sinuatus.png")
...
png("EnviremPlot_Mean.AUC_sinuatus.png")
...
writeRaster(pred.env,filename="EnviremPlot_PredRaw_BestModel_sinuatus.asc",
            format="ascii",overwrite=T)
png("EnviremPlot_PredRaw_BestModel_sinuatus.png")
...
writeRaster(p3.nomit,filename="Envirem_Thresh_NoOmission_BestModel_sinuatus.asc",
            format="ascii",overwrite=T)
writeRaster(p3.equal,filename="Envirem_Thresh_EqualSensSpec_BestModel_sinuatus.asc",
            format="ascii",overwrite=T)

png("Envirem_Thresh_NoOmission_BestModel_sinuatus.png")
plot(p3.nomit, col=viridis::viridis(99))
dev.off()
png("Envirem_Thresh_EqualSensSpec_BestModel_sinuatus.png")
...
png("LGM_Microc_PredRaw_BestModel_sinuatus.png")
...
writeRaster(lgm.pred.thin,filename="LGM_Microc_PredRaw_BestModel_sinuatus.asc",
            format="ascii",overwrite=T)
writeRaster(p4.nomit,filename="LGM_Miroc_Thresh_NoOmission_BestModel_sinuatus.asc",
            format="ascii",overwrite=T)
writeRaster(p4.equal,filename="LGM_Miroc_Thresh_EqualSensSpec_BestModel_sinuatus.asc",
            format="ascii",overwrite=T)

png("LGM_Miroc_Thresh_NoOmission_BestModel_sinuatus.png")
plot(p4.nomit, col=viridis::viridis(99))
dev.off()
png("LGM_Miroc_Thresh_EqualSensSpec_BestModel_sinuatus.png")
...
png("LGM_Mpi_PredRaw_BestModel_sinuatus.png")
plot(lgm.pred.thin, col=viridis::viridis(99))
#points(newthin[,2:3],col="red")
dev.off()
...
writeRaster(lgm.pred.thin,filename="LGM_Mpi_PredRaw_BestModel_sinuatus.asc",
            format="ascii",overwrite=T)
writeRaster(p5.nomit,filename="LGM_Mpi_Thresh_NoOmission_BestModel_sinuatus.asc",
            format="ascii",overwrite=T)
writeRaster(p5.equal,filename="LGM_Mpi_Thresh_EqualSensSpec_BestModel_sinuatus.asc",
            format="ascii",overwrite=T)


png("LGM_Mpi_Thresh_NoOmission_BestModel_sinuatus.png")
plot(p5.nomit, col=viridis::viridis(99))
dev.off()
png("LGM_Mpi_Thresh_EqualSensSpec_BestModel_sinuatus.png")
...
png("LGM_Ccsm4_PredRaw_BestModel_sinuatus.png")
plot(lgm.pred.thin, col=viridis::viridis(99))
#points(newthin[,2:3],col="red")
dev.off()
...
writeRaster(lgm.pred.thin,filename="LGM_Ccsm4_PredRaw_BestModel_sinuatus.asc",
            format="ascii",overwrite=T)
writeRaster(p6.nomit,filename="LGM_Ccsm4_Thresh_NoOmission_BestModel_sinuatus.asc",
            format="ascii",overwrite=T)
writeRaster(p6.equal,filename="LGM_Ccsm4_Thresh_EqualSensSpec_BestModel_sinuatus.asc",
            format="ascii",overwrite=T)

png("LGM_Ccsm4_Thresh_NoOmission_BestModel_sinuatus.png")
plot(p6.nomit, col=viridis::viridis(99))
dev.off()
png("LGM_Ccsm4_Thresh_EqualSensSpec_BestModel_sinuatus.png")
